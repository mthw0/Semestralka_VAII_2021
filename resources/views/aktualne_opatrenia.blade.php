...
<div class="container">
    ...
    <p>
    <ul>
        <li>Medzi kompletne zaočkované osoby sa pre potreby vyhlášky považujú <strong>deti do 12 rokov a 2 mesiacov veku</strong>. (Vysvetlenie: lehota bola stanovená tak, aby osobe vo veku 12 rokov po očkovaní uplynul potrebný čas, pri ktorom je predpoklad, že sa v tele stihne vytvoriť dostatočná hladina ochranných protilátok.)
        </li>
        <li>
            <strong>Hodiny vyhradené pre seniorov a ŤZP sa po novom rušia.</strong> Doteraz bolo potrebné, aby seniorské hodiny vyčlenili prevádzky v bordových a čiernych okresoch v režime “základ”.
        </li>
        <li>
            <strong>Explicitne sa uvádza, že pri vstupe do prevádzky je povinné zvoliť si režim, mať o tom na viditeľnom mieste oznámenie a zabezpečiť vstup do priestorov len účastníkom v zvolenom režime (základ, OTP, kompletne zaočkovaní).</strong> Režim, v ktorom prevádzka funguje, musí viditeľne vyznačiť vo svojich priestoroch. Organizátor hromadného podujatia takisto musí pri vstupe viditeľne označiť, ktorým osobám umožní vstup.
        </li>
        <li>
            <strong>Režim (základ, OTP, kompletne zaočkovaní) na vstupe do prevádzky si nie sú povinné označiť esenciálne prevádzky a služby.</strong> Ide napríklad o potraviny, drogérie, lekárne, očné optiky a predajne zdravotníckych pomôcok, kúpele poskytujúce procedúry na základe návrhu lekára, predajne novín a tlačovín, predajne s krmivom pre zvieratá a veterinárne ambulancie, knižnice, čerpacie stanice, opravovne a servis elektroniky strojov, služby STK a emisnej kontroly a podobne.
        </li>
        <li>
            <strong>Pre zhoršujúcu sa epidemiologickú situáciu sa explicitne zakazuje kombinovanie rôznych režimov pre jedno hromadné podujatie.</strong>
        </li>
    </ul>
    </p>
   ...
   <p>Za osobu v režime očkovaná, testovaná, alebo prekonala ochorenie COVID-19 (ďalej len „ osoba v režime OTP“) sa považuje:</p>
   <ul>
       <li>
           osoba plne očkovaná,
       </li>
