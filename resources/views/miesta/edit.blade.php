...
<div class="container">
    ...
    <form method="post" action="{{ route('miesta.update',$miesto->id) }}">
        ...
        <div>
            ...
            <input type="text" name="nazov" value="{{ $miesto->nazov }}" class="form-control" placeholder="Nazov" required />
            <label class="label">Adresa</label>
            <input type="text" name="adresa" value="{{ $miesto->adresa }}" class="form-control" placeholder="Adresa" required />
            <label class="label">Popis</label>
            <input type="text" name="popis" value="{{ $miesto->popis }}" class="form-control" placeholder="Popis" required />
